...
namespace FamiliaXamarin
{
    class Constants
    {
        ...
        public static string ServerAddress { get; } = "http://192.168.0.148:3000/";

        //public static string PublicServerAddress { get; } = "https://gisdev.indecosoft.net/chat";
        public static string PublicServerAddress { get; } = "http://192.168.101.86:3000";
        //public static string WebSocketAddress { get; } = "https://gisdev.indecosoft.net/ws";
        public static string WebSocketAddress { get; } = "http://192.168.101.86:3000/ws";
