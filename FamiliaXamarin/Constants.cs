...
namespace Familia {
	internal class Constants {
		...
		// public static string SaveDeviceDataUrl { get; } = "http://192.168.101.12/devices/save-device-measurements";
		// public static string PublicServerAddress { get; } = "http://192.168.101.12:3000";
		// public static string WebSocketLocationAddress { get; } = "http://192.168.101.12:3000/location";
		//public static string WebSocketAddress { get; } = "http://192.168.101.12:3000/ws";
