...
namespace FamiliaXamarin {
    class Constants {
        ...
        public static string SaveDeviceDataUrl { get; } = "https://gisdev.indecosoft.net/devices/save-device-measurements";
           //    public static string SaveDeviceDataUrl { get; } = "http://192.168.0.242/devices/save-device-measurements";
        public static string PublicServerAddress { get; } = "https://gisdev.indecosoft.net/chat";
           //    public static string PublicServerAddress { get; } = "http://192.168.0.242:3000";

          //      public static string WebSocketLocationAddress { get; } = "http://192.168.0.242:3000/location";
        public static string WebSocketLocationAddress { get; } = "https://gisdev.indecosoft.net/location";
         //     public static string WebSocketAddress { get; } = "http://192.168.0.242:3000/ws";
